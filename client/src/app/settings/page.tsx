...
const Settings = () => {
  ...
  const handleToggleChange = (index: number) => {
    ...
    updatedSettings[index].value = !updatedSettings[index].value as boolean;
              ...
              <tr key={setting.label} className="hover:bg-blue-50">
                ...
                <td className="py-2 px-4">
                  {setting.type === "toggle" ? (
                    ...
                    <input
                      type="text"
                      className="px-4 py-2 w-full rounded-lg border text-gray-500 focus:outline-none focus:border-blue-500"
